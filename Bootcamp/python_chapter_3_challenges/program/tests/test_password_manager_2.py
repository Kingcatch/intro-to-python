...
class TestPasswordManager2():
    ...
    def test_sort_by_last_updated(self):
        ...
        password_manager.add('acebook', '$12345678')
        password_manager.add('makersbnb', '@12345678')
        password_manager.update('acebook', '$12345679')

        assert password_manager.sort_services_by('updated_on') == [
            'baidu',
            'makersbnb',
            'acebook',
        ]

    def test_sort_reverse_last_updated(self):
        password_manager = PasswordManager2()
        password_manager.add('baidu', '%12345678')
        password_manager.add('acebook', '$12345678')
        password_manager.add('makersbnb', '@12345678')
        ...
        assert password_manager.sort_services_by('updated_on', 'reverse') == [
            'acebook',
            'makersbnb',
            'baidu',
        ]